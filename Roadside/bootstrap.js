...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "Roadside.controller.Application": [],
  "Roadside.controller.Guest": [],
  "Roadside.controller.Location": [],
  "Roadside.controller.Login": [],
  "Roadside.controller.Registration": [],
  "Roadside.model.Contact": [],
  "Roadside.model.Guest": [],
  "Roadside.model.Location": [],
  "Roadside.model.Registration": [],
  "Roadside.model.ShareLocation": [],
  "Roadside.model.UserProfile": [],
  "Roadside.store.Contacts": [],
  "Roadside.store.Guest": [],
  "Roadside.store.Registration": [],
  "Roadside.store.UserProfileStore": [],
  ...
  "Roadside.view.Login": [],
  "Roadside.view.Main": [],
  "Roadside.view.MainMenu": [],
  "Roadside.view.MainPanel": [],
  "Roadside.view.MainProfile": [],
  "Roadside.view.MapTest": [],
  "Roadside.view.MenuItems": [],
  "Roadside.view.Registration": [],
  "Roadside.view.Services": [],
  "Roadside.view.Towing": [],
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "Roadside.view.Towing": [
    "widget.towing-location"
  ],
  "Roadside.view.contact.Edit": [
    "widget.contact-edit"
  ],
  "Roadside.view.contact.ShareLocation": [
    "widget.share-location"
  ],
  "Roadside.view.contact.Show": [
    "widget.contact-show"
  ],
  "Roadside.view.contact.ShowCurrentLoc": [
    "widget.current-location-show"
  ]
});
